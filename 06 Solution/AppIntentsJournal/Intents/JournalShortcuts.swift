...
class JournalShortcuts: AppShortcutsProvider {
    ...
    static var appShortcuts: [AppShortcut] {
        ...
        AppShortcut(
            intent: MoodIntent(),
            phrases: [
                "Do a mood check-in in\(.applicationName)",
        ...
        AppShortcut(
            intent: ComposeNewJournalEntry(),
            phrases: [
                "Start a new journal entry in\(.applicationName)",
                "Write a journal entry in \(.applicationName)",
                "Compose a new journal entry in \(.applicationName)"
            ],
